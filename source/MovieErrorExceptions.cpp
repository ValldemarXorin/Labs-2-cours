...
void MovieErrorExceptions::validate_time(const std::string &time) const {
...
void MovieErrorExceptions::validate_age_limit(const std::string &age_limit) const {
...
void MovieErrorExceptions::validate_year(int year) const {
    if (year <= 1850) {
