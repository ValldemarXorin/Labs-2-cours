...
"    }"));
        ...
        GenreText->setGeometry(QRect(220, 110, 71, 20));
...
"    }"));
        ...
        Genre->setGeometry(QRect(307, 110, 280, 20));
...
"    }"));
        ...
        YearText->setGeometry(QRect(220, 130, 71, 20));
...
"    }"));
        ...
        Year->setGeometry(QRect(307, 130, 280, 20));
...
"    }"));
        ...
        RuntimeText->setGeometry(QRect(220, 150, 71, 20));
...
"    }"));
        ...
        AgeLimitText->setGeometry(QRect(220, 170, 71, 20));
...
"    }"));
        ...
        Runtime->setGeometry(QRect(307, 150, 280, 20));
...
"    }"));
        ...
        AgeLimit->setGeometry(QRect(307, 170, 280, 20));
...
"    }"));
        ...
        TrailerLinkText->setGeometry(QRect(210, 190, 91, 20));
...
"    }"));
        ...
        TrailerLink->setGeometry(QRect(307, 190, 280, 20));
...
"    }"));
        ...
        Rating->setGeometry(QRect(330, 50, 51, 41));
...
"    }"));
        ...
        Description->setGeometry(QRect(20, 265, 571, 151));
...
"    }"));
        ...
        LikeButton->setGeometry(QRect(540, 20, 51, 51));
...
"}"));
        starIcon = new QLabel(MovieCardInfo);
        starIcon->setObjectName("starIcon");
        starIcon->setGeometry(QRect(390, 60, 21, 21));
    ...
    void retranslateUi(QWidget *MovieCardInfo)
    {
        ...
        starIcon->setText(QCoreApplication::translate("MovieCardInfo", "TextLabel", nullptr));
    } // retranslateUi
